...
def read_dir(dir_path: Path) -> Iterator[str]:
    ...
    # TODO: Do not enforce a particular file name extension for the trained model.
    # In other words, the user is free to define the file name including the extension
    # (e.g. .file, .jm, .data, etc.).
